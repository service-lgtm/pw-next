  ...
  return (
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        {/* 产出信息 - 仅矿山类型显示 */}
        {isMineType && land.blueprint.output_resource && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gray-700/50 rounded-lg p-4">
                <p className="text-sm text-gray-400 mb-1">资源类型</p>
                <p className="text-xl font-bold text-green-500">
                  {land.blueprint.output_resource === 'stone' ? '石头' : 
                   ...
                   land.blueprint.output_resource}
                </p>
              </div>
              <div className="bg-gray-700/50 rounded-lg p-4">
                <p className="text-sm text-gray-400 mb-1">累计产出</p>
                <p className="text-xl font-bold">{land.accumulated_output || '0.0000'}</p>
              </div>
              <div className="bg-gray-700/50 rounded-lg p-4">
        ...
        {/* 产出信息 - 非矿山类型 */}
        {!isMineType && land.blueprint.daily_output !== '0.0000' && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3 }}
        ...
        >
          ...
          {land.recent_transactions && land.recent_transactions.length > 0 ? (
            <div className="space-y-3">
              {land.recent_transactions.map((tx: any) => (
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span>{Math.round(discountedPrice / (land.blueprint.size_sqm || land.size_sqm))} TDB/㎡</span>
                </div>
                <div className="flex justify-between text-sm">
            ...
            <>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  单价: {Math.round(Number(land.current_price) / (land.blueprint.size_sqm || land.size_sqm))} TDB/㎡
                </p>
              </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className={cn(
                ...
                {land.status === 'unowned' ? '可购买' : land.status === 'owned' ? '已拥有' : '已售出'}
              </span>
            </div>
