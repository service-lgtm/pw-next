...
const faqData = [
  {
    ...
    questions: [
      {
        q: '平行世界的字符是什么？',
        a: '平行世界的字符是把现实世界实体通过区块链技术1：1映射到虚拟世界，通过黄金锚定社会商品，实现全民淘金，全民再造新世界的场景式“玩转经济”的数字化平台。',
      },
      {
        q: '需要投入多少钱？',
        a: '0元即可开始！您可以通过完成任务、推荐好友等方式赚取更多积分。',
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: 'TDB和YLD有什么区别？',
        a: '一个负责全球结算，一个负责全球流通。全球流通的给全球结算的做支撑，全球结算的给全球流通的做保障。',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      {
        q: '如何快速升级？',
        a: '个人消费+公会业绩是升级关键。多推荐活跃用户，帮助团队成员成长，您的等级和收益都会快速提升。',
      },
    ],
  },
]
